...
- `test.html`: 현재 시각을 2027년 1월 25일로 고정해 약 39% 진행 상태를 보여 준다.
- `test2.html`: 현재 시각을 2027년 2월 15일로 고정해 여행 종료 `D+15` 상태를 보여 준다.
...
- 인증, 알림, 버전, 가계부 항목 수정, 카테고리, 지도, 가져오기, 내보내기용 대화상자
